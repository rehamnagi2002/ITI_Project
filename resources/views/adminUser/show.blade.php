...
<body>
    ...
    <div class="container">
        <h2>Orders of {{ $adminUser->name }}</h2>
        <ul class="nav nav-underline justify-content-end ">
            <li class="nav-item dropdown ">
                ...
                <ul class="dropdown-menu dropdown-menu-light dropdownChild">
                    <li><a href="{{ route('adminUser.index') }}">Back</a></li>
    ...
    <table class=>
        ...
        <tbody>
            @foreach ($adminUser->orders as $order)
                <tr>
                    <td class="catename">{{ $order->id }}</td>
                    <td class="catename"><span>$</span>{{ $order->price }}</td>
                </tr>
            @endforeach
        </tbody>
    </table>
